                ...
                <TabsContent value="checklists">
                  ...
                  <div className="space-y-4">
                    {checklists.map((checklist) => (
                      <Card
                        key={checklist.id}
                        className="bg-white dark:bg-gray-800 border border-border shadow rounded-2xl"
                      >
                  ...
                  <TabsContent value="roles">
                    ...
                    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                      {roles.map((role) => (
                        <Card
                          key={role.id}
                          className="bg-white dark:bg-gray-800 text-foreground border border-border rounded-2xl shadow-sm transition hover:shadow-md"
                        >
                          <CardContent className="p-4">
                      ...
                      {roles.length === 0 && (
                        <Card className="bg-white dark:bg-gray-800 text-muted-foreground border border-border rounded-2xl shadow-sm text-center">
