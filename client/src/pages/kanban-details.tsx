...
function KanbanCardComponent({
  ...
  return (
    <Card
      ...
      className="relative bg-white dark:bg-gray-900 rounded-2xl border border-border cursor-pointer hover:shadow-md transition-shadow touch-manipulation select-none"
    >
