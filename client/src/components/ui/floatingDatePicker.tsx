  ...
  return (
    <div className={`relative w-full max-w-sm ${className ?? ""}`}>
      ...
      <DatePicker
        ...
        className="peer w-full h-12 px-4 py-3 text-base border border-slate-400 rounded-md bg-transparent transition duration-300 ease focus:outline-hidden focus:border-slate-400 hover:border-slate-300 shadow-xs focus:shadow-sm"
      />
    </div>
  );
}
